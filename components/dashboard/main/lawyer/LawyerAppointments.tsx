...
import { useLawyerAppointments } from "@/api/MyLawyerApi";
  ...
  return (
    <div>
      ...
      {appointments?.data?.data?.length > 0 && (
        <div className="h-[550px] sm:h-[575px] xl:h-[585px] rounded-md w-[70vw] sm:w-[82vw] lg:w-[80vw] xl:w-full overflow-scroll mt-5">
          <table
            className={`${
          ...
          >
            <thead className="border-b-2 border-slate-800 bg-blue-100">
              <tr className="text-slate-800">
                <th className="py-2 px-4 border-b">موکل</th>
